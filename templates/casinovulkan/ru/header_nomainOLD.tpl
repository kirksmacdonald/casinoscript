...
<div class="tail-top">
    <div class="main">
		...
		<? if(!$_SESSION['login']) { ?>
<br>
<object type="application/x-shockwave-flash" data="/bottonLeft_230x75.swf" width="230" height="75">
<param name="movie" value="/bottonLeft_230x75.swf" />
<param name="wmode" value="transparent" />
<?php /*<param name="FlashVars" value="link1=/{language}/open_account" /> */ ?>
<param name="FlashVars" value="link1=javascript:showRegistrationForm()" />
</object>
<object type="application/x-shockwave-flash" data="/bottonRight_230x75.swf" width="230" height="75">
<param name="movie" value="/bottonRight_230x75.swf" />
<param name="wmode" value="transparent" />
...
<? } ?> 
		   ...
		   <script type=text/javascript> 
				...
				window.external.addFavorite ('http://casino-zodiac.org' , 'casino-zodiac.org')
				}
				-->
			</script>
			<div id="cz_bookmark_lnk">
				<a onClick="AddBookmark();return false" href="http://casino-zodiac.org/index.php">Добавить в закладки</a>
			</div>
...
<?php } ?>
	...
	<div class="hidden">
		<form id="reg_form" method="post" action="">
			...
			<table style="color: #ffffff; text-align: left; font-size: 10px;" width="500" border="0" cellpadding="0" cellspacing="0">
				<tr>
					<td width="120">&nbsp;</td>
					<td>&nbsp;</td>
				</tr>
				...
				<tr>
					...
					<td>
						...
						<label for="confirm" class="confirm">Я принимаю <a href="/{language}/terms">правила и условия казино Zodiac</a></label>
					</td>
				</tr>
				<tr>
					<td>&nbsp;</td>
                                    ...
                                    <div class="indent-box">
                                        ...
                                        <div class="container">
                                            <div class="col-1">
                                                ...
                                                <div class="box1" <?if ($page != 'index' and $page != 'open_account' and $page != 'support' and $page != 'login' and $page != 'forgot_password') { echo 'style="width:900px;"';}?>>
