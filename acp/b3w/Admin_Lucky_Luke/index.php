<?// include ("header.php");
$game = "luke";       // название игры$gamestat = "luke"; // название в стате
$gamewid = "Ковбой Люк";
  ...
  <body>
   <style type="text/css">
    ...
    <table align="center" >
     <tr><td>
     <center>
     <h4><font face="Verdana" color="#7C87C2" ><? include ("$bru")?></font></h4></center><br> 
      <FORM name="setings" action=bankserver.php method=post>
       ...
       <table border="0" align="center" bgcolor=<? echo $bgctable_1 ?> >
        <TR>
         ...
         <TD align="right" >Банк 25 линейных слотов
          <INPUT class="1_input" maxLength=20 size=10 name=game_proc value="<? echo $ron[bank] ?>" > Руб.</TD>
        ...
        <TR>
         <TD align="right" >Банк игры <? echo $gamewid ; ?>
          <INPUT class="1_input" type="text" maxLength=20 size=10 name=<?echo "$game";?>_bank value="<? echo $rom['bank'] ?>" > Руб.</TD>
         <TD align="right" >Процент выдачи на 1 спин
          <INPUT class="1_input" maxLength=20 size=10 name=<?echo "$game";?>_proc value="<? echo $rom['proc'] ?>" > %.&nbsp;&nbsp;</TD>
         <TD align="right">Забираем с каждого спина
          <INPUT class="1_input" maxLength=5 size=10 name=<?echo "$game";?>_income value="<? echo $rom['income'] ?>" > %</TD>
        </TR> 
        <TR >
        ...
        <TR>
          <TD align="right" >Лимит на 1 спин max.
           <INPUT class="1_input" maxLength=20 size=10 name=<?echo "$game";?>_winlimit_1 value="<? echo $rom['winmax'] ?>" >  Руб.</TD>
        ...
        <TR>
         <TD align="right" >Банк Бонуса
          <INPUT class="1_input" maxLength=20 size=10 name=<?echo "$game";?>_bonus_bank value="<? echo $rom['bonus'] ?>"     >  Руб.</TD>
         <TD align="right" >Сума готовности выдачи бонуса
          <INPUT class="1_input" maxLength=10 size=10 name=<?echo "$game";?>_bonus_out value="<? echo $rom['bonusready'] ?>" > руб.</TD>
         <TD align="right">Забираем с каждого спина
          <INPUT class="1_input" maxLength=5 size=10 name=<?echo "$game";?>_bonus_proc value="<? echo $rom['bonusproc'] ?>"  > % </TD>
        </TR>
        <TR>
       ...
       <table border="0" align="center" bgcolor=<? echo $bgctable_2 ?> >
        <TR>
         <TD align="right" ><font face="Verdana">Слот работает с общим банком казино</font>
          <INPUT class="2_checkbox" type="radio" name="<?echo "$game";?>_bankset"  value="0000000001" <? echo $mode0001; ?>>&nbsp;</TD>
         <TD  align="left" ><font face="Verdana">Слот работает с общим банком для 25 линейных слотов</font>
          <INPUT class="2_checkbox" type="radio" name="<?echo "$game";?>_bankset"  value="0000000002" <? echo $mode0002; ?>>&nbsp;</TD>
         <TD align=right ><font face="Verdana" >Слот работает с отдельным банком  </font>
          <INPUT class="2_checkbox" type="radio" name="<?echo "$game";?>_bankset" value="0000000004" <? echo $mode0004; ?>>&nbsp;</TD>
        </TR>
       </table>
        <!-- настройка Валюты -->
       ...
       <table border="0" align="center" bgcolor=<? echo $bgctable_3 ?> >
        <TR>
         ...
         <TD>&nbsp;&nbsp;&quot;Ru&quot; 
          <INPUT class="3_input" type="radio" name=<?echo "$game";?>_valuta value="Ru" <? echo $valutypr ; ?> >¤ </TD>
         <TD>&nbsp;&nbsp;&quot;$&quot;
          <INPUT class="3_input" type="radio" name=<?echo "$game";?>_valuta value="$"  <? echo $valutypd ; ?> >¤ </TD>
         <TD>&nbsp;&nbsp;&quot;€&quot;
          <INPUT class="3_input" type="radio" name=<?echo "$game";?>_valuta value="€"  <? echo $valutype ; ?> >¤ </TD>
         <TD>&nbsp;&nbsp;&quot;UA&quot;
          <INPUT class="3_input" type="radio" name=<?echo "$game";?>_valuta value="UA" <? echo $valutypg; ?> >¤ </TD>
         <TD>&nbsp;&nbsp;&quot;BZ&quot;
          <INPUT class="3_input" type="radio" name=<?echo "$game";?>_valuta value="BZ" <? echo $valutypz; ?> >¤ </TD>
         <TD>&nbsp;&nbsp;&quot;KZ&quot;
          <INPUT class="3_input" type="radio" name=<?echo "$game";?>_valuta value="KZ" <? echo $valutypt; ?> >¤ </TD>
         <TD>&nbsp;&nbsp;&quot;LV&quot;
          <INPUT class="3_input" type="radio" name=<?echo "$game";?>_valuta value="LV" <? echo $valutypl; ?> >¤ </TD>
         <TD>&nbsp;&nbsp;&quot;Fun&quot;
          <INPUT class="3_input" type="radio" name=<?echo "$game";?>_valuta value="FU" <? echo $valutypf; ?> >¤ </TD>
        </TR>
        <TR>
         <TD align="right"> валюта отображаемая в слоте</TD>
         <TD colspan=4 align="left" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <INPUT class="3_input" maxLength=2 size=2 name=<?echo "$game";?>_valutaset value="<? echo $valu_array[1] ?>" >.
            определить тип самостоятельно
          <INPUT class="3_input" type="radio" maxLength=2 size=2 name=<?echo "$game";?>_valuta <? echo $valutypx ?>    ></TD>
         <TD colspan=4 align="left" >
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Активировать выбор ставки  пользователями
          <INPUT class="6_input" type="checkbox" maxLength=2 size=2 name=<?echo "$game";?>_useron value="Y"<? echo $setuseron ?> >. </TD>
        </TR>
        <TR>
         <TD align="right">Определяем величины ставок</TD>
         <TD>&nbsp;&nbsp;#1
          <INPUT class="3_input" maxLength=4 size=4 name=<?echo "$game";?>_vol1 value="<? echo $stav_array[0] ?>" >. </TD>
        <TD>&nbsp;&nbsp;#2
         <INPUT class="3_input" maxLength=3 size=4 name=<?echo "$game";?>_vol2 value="<? echo $stav_array[1] ?>" >. </TD>
        <TD>&nbsp;&nbsp;#3
         <INPUT class="3_input" maxLength=3 size=4 name=<?echo "$game";?>_vol3 value="<? echo $stav_array[2] ?>" >. </TD>
        <TD>&nbsp;&nbsp;#4
         <INPUT class="3_input" maxLength=3 size=4 name=<?echo "$game";?>_vol4 value="<? echo $stav_array[3] ?>" >. </TD>
        <TD>&nbsp;&nbsp;#5
         <INPUT class="3_input" maxLength=3 size=4 name=<?echo "$game";?>_vol5 value="<? echo $stav_array[4] ?>" >. </TD>
        <TD>&nbsp;&nbsp;#6
         <INPUT class="3_input" maxLength=3 size=4 name=<?echo "$game";?>_vol6 value="<? echo $stav_array[5] ?>" >. </TD>
        <!--  <TD>&nbsp;&nbsp;#7
         <INPUT class="3_input" maxLength=3 size=4 name=<?echo "$game";?>_vol7 value="<? echo $stav_array[6] ?>" >. </TD>
        <TD>&nbsp;&nbsp;#8
         <INPUT class="3_input" maxLength=3 size=4 name=<?echo "$game";?>_vol8 value="<? echo $stav_array[7] ?>" >. </TD> -->
        </TR>
        <TR>
         <TD align="right">Минимальная ставка в выбраной валюте</TD>
         <TD>&nbsp;&nbsp;#1&nbsp;
          <INPUT class="3_input" type="radio" name=<?echo "$game";?>_stav value="<? echo $stav_array[0] ?>" <? echo $stav1 ?> >¤ </TD>
         <TD>&nbsp;&nbsp;#2&nbsp;
          <INPUT class="3_input" type="radio" name=<?echo "$game";?>_stav value="<? echo $stav_array[1] ?>" <? echo $stav2 ?> >¤ </TD>
         <TD>&nbsp;&nbsp;#3&nbsp;
          <INPUT class="3_input" type="radio" name=<?echo "$game";?>_stav value="<? echo $stav_array[2] ?>" <? echo $stav3 ?> >¤ </TD>
         <TD>&nbsp;&nbsp;#4&nbsp;
          <INPUT class="3_input" type="radio" name=<?echo "$game";?>_stav value="<? echo $stav_array[3] ?>" <? echo $stav4 ?> >¤ </TD>
         <TD>&nbsp;&nbsp;#5&nbsp;
          <INPUT class="3_input" type="radio" name=<?echo "$game";?>_stav value="<? echo $stav_array[4] ?>" <? echo $stav5 ?> >¤ </TD>
         <TD>&nbsp;&nbsp;#6&nbsp;
          <INPUT class="3_input" type="radio" name=<?echo "$game";?>_stav value="<? echo $stav_array[5] ?>" <? echo $stav6 ?> >¤ </TD>
         <!--   <TD>&nbsp;&nbsp;#7&nbsp;
          <INPUT class="3_input" type="radio" name=<?echo "$game";?>_stav value="<? echo $stav_array[6] ?>" <? echo $stav7 ?> >¤ </TD>
         <TD>&nbsp;&nbsp;#8&nbsp;
          <INPUT class="3_input" type="radio" name=<?echo "$game";?>_stav value="<? echo $stav_array[7] ?>" <? echo $stav8 ?> >¤ </TD> -->
        </TR>
       </table>
         <!-- модул "ДжекПот -->   
       ...
       <TABLE border="0" align="center" bgcolor=<? echo $bgctable_2 ?> >
        <TR>
         ...
         <TD>&nbsp;&nbsp; Забираем с каждого спина в банк "ДжекПота"
          <INPUT class="2_input" maxLength=20 size=10 name=<?echo "$game";?>_jpotproc value="<? echo $rom['jpotproc'] ?>" >%. </TD>
         <TD><LI>Слот участвует в "ДжекПоте"</LI>
          <INPUT class="2_input" type=checkbox maxLength=20 size=10 name=<?echo "$game";?>_jpotyes value="0000000010"<? echo $mode0010 ?> >  </TD>
        </TR>
         <!-- кнопка--> 
        <table align="center" >
         <TR>
