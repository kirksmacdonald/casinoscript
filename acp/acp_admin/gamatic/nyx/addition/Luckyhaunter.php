<?php #::[ админ панель :: настройка бонус-игры 9 линейных слотов Igrosoft R#1201161515v4.62]::# ?>
          -->
          <!-- настройка бонус-игры Лайки хантер-->
          ...
          <div class="stub6"><span class="snosko">&nbsp;* </span><span class="snoskotext">Если выставить меньше 5-ти игроку не дойти до супербонус-игры(курица) </span></div>
          <div class="lineshr"></div>
