...
if ( $режим == "senduser" && $user_login != "" )
{
    ...
    echo "er>";
    echo "<S";
    echo "PAN class=pageheader>Отправка email сообщения > ";
    echo "<S";
    echo "PAN class=subhead>Пользователю </SPAN></SPAN><BR><BR>\r\n                   <UL id=nav>\r\n                     <LI><A class=selected href=\"admin_mass_email.php\">Рассылка</A>\r\n             </LI></UL></DIV></TD></TR></TBODY></TABLE><!--end of tab navigation--></TD></TR><!--end banner -->\r\n         <TR><!--begin main content tables --->\r\n           <TD vAlign=top>\r\n             <TABLE cellSpacing=0 cellPadding=0 width=\"100%\">";
    echo "\r\n               <TBODY>\r\n               <TR>\r\n                 <TD width=10><IMG height=8\r\n                   src=\"templates/images/spacer.gif\"\r\n                 width=10></TD>\r\n                 <TD>               </TD></TR></TBODY></TABLE>\r\n             ";
    echo "<S";
    echo "TYLE type=text/css>.drag {\r\n \tCURSOR: hand\r\n }\r\n </STYLE>\r\n             <DIV id=dHTMLToolTip\r\n             style=\"Z-INDEX: 1000; LEFT: 0px; VISIBILITY: hidden; WIDTH: 10px; POSITION: absolute; TOP: 0px; HEIGHT: 10px\"></DIV>\r\n           </TD></TR>\r\n             <TD class=tableheader>ОТОСЛАТЬ СООБЩЕНИЕ: <a href=\"";
    echo $_SERVER['HTTP_REFERER'];
    echo "\">ВЕРНУТСЯ НАЗАД</a></TD>\r\n         <TR>\r\n           <TD height=\"241\" vAlign=top>\r\n                           <form method=\"post\" action=\"admin_mass_email.php?mode=senduser&login=";
    echo $_GET['login'];
    echo "\">\r\n           \t\t\t\t   <TABLE class=editTable cellSpacing=0 cellPadding=5 border=0>\r\n                           <TBODY>\r\n                       \t   <TR>\r\n                             <TD class=colheader colSpan=4>Рассылка по имени</TD>\r\n                           </TR>\r\n                           <TR>\r\n                             <TD class=tabledata>Имя пользователя:</TD>\r\n                             <TD c";
    echo "lass=tabledata colSpan=3>\r\n                                <b>";
    echo $_GET['login'];
    echo "</b>\r\n                             \t<INPUT type=\"hidden\" name=\"login\" value=\"";
    echo $_GET['login'];
    echo "\">\r\n                             \t<input type=\"hidden\" name=\"gr11\" value=\"mass_user\">\r\n                             </TD>\r\n                           </TR>\r\n                           <TR>\r\n                             <TD class=colheader colSpan=4>Сообщение</TD>\r\n                           </TR>\r\n                           <TR>\r\n                             <TD class=tabledata>Тема:</TD>\r\n                 ";
    echo "            <TD class=tabledata colSpan=3><INPUT name=\"subject\" id=\"casinoemail\" value=\"";
    echo $рассылка_тема;
    echo "\" size=80 maxLength=500></TD>\r\n                           </TR>\r\n                           <TR>\r\n                             <TD class=tabledata>Сообщение:</TD>\r\n                             <TD class=tabledata colSpan=3></TD>\r\n                           </TR>\r\n                           <TR>\r\n                             <TD class=tabledata colspan=4>\r\n\r\n    <div id=\"alerts\">\r\n\t\t<noscript>\r\n\t\t\t<p>\r\n\t\t\t\t";
    echo "<s";
    echo "trong>CKEditor requires JavaScript to run</strong>. In a browser with no JavaScript\r\n\t\t\t\tsupport, like yours, you should still see the contents (HTML data) and you should\r\n\t\t\t\tbe able to edit it normally, without a rich editor interface.\r\n\t\t\t</p>\r\n\t\t</noscript>\r\n\t</div>\r\n\t<!-- This <fieldset> holds the HTML that you will usually find in your pages. -->\r\n\t<fieldset title=\"Output\">\r\n\t\t\t<p>\r\n\t\t\t";
