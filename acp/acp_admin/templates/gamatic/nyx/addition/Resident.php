<?php #::[ админ панель :: настройка бонус-игры 9 линейных слотов Igrosoft R#1201161515v4.62]::# ?>
          ...
          <div class="bankvol">Max.</div><!-- В данном релизе есть огнетушитель -->
          <div class="stub6"><span class="snosko">&nbsp;* </span><span class="snoskotext">&quot;Огнетушитель&quot; так-же учитывается.Если выставить меньше 4-х игроку не дойти до <acronym title="&quot;Дверь&quot;- это призовая игра, при достежении бонус-банка суммы готовности выдачи, запускается супер-призовая игра с выдачей игроку 95% бонусного-банка">&quot;дверей&quot;</acronym></span></div>
          <div class="lineshr"></div>
