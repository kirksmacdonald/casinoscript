...
print "<meta name=\"keywords\" content=\"RouletteSilver\">";
print "<title>RouletteSilver</title>";
print "<meta name=\"keywords\" content=\"RouletteSilver\">";
...
print "<param name=\"movie\" value=\"RouletteSilver.swf\">";
print "<param name=\"quality\" value=\"high\" />";
print "<param name=\"wmode\" value=\"transparent\" />";
print "</object>";
print "</div>";
print "<script type=\"text/javascript\">";
print "var fo = new FlashObject(\"RouletteSilver.swf\", \"\", \"100%\", \"100%\", \"7\", \"\");";
