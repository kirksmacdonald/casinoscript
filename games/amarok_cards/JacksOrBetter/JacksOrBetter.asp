...
print "<meta name=\"keywords\" content=\"JacksOrBetter\">";
print "<title>JacksOrBetter</title>";
print "<meta name=\"keywords\" content=\"JacksOrBetter\">";
...
print "<param name=\"movie\" value=\"JacksOrBetter.swf\">";
print "<param name=\"quality\" value=\"high\" />";
print "<param name=\"wmode\" value=\"transparent\" />";
print "</object>";
print "</div>";
print "<script type=\"text/javascript\">";
print "var fo = new FlashObject(\"JacksOrBetter.swf\", \"\", \"100%\", \"100%\", \"7\", \"\");";
