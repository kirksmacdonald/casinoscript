...
print "<meta name=\"keywords\" content=\"BlackJackSilver\">";
print "<title>BlackJackSilver</title>";
print "<meta name=\"keywords\" content=\"BlackJackSilver\">";
...
print "<param name=\"movie\" value=\"BlackJackSilver.swf\">";
print "<param name=\"quality\" value=\"high\" />";
print "<param name=\"wmode\" value=\"transparent\" />";
print "</object>";
print "</div>";
print "<script type=\"text/javascript\">";
print "var fo = new FlashObject(\"BlackJackSilver.swf\", \"\", \"100%\", \"100%\", \"7\", \"\");";
