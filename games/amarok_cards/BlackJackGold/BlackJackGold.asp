...
define("_GAME_NAME", "BlackJackGold");
...
print "<meta name=\"keywords\" content=\"BlackJackGold\">";
print "<title>BlackJackGold</title>";
print "<meta name=\"keywords\" content=\"BlackJackGold\">";
...
print "<param name=\"movie\" value=\"BlackJackGold.swf\">";
print "<param name=\"quality\" value=\"high\" />";
print "<param name=\"wmode\" value=\"transparent\" />";
print "</object>";
print "</div>";
print "<script type=\"text/javascript\">";
print "var fo = new FlashObject(\"BlackJackGold.swf\", \"\", \"100%\", \"100%\", \"7\", \"\");";
