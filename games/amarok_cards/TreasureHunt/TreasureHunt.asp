...
print "<meta name=\"keywords\" content=\"Candies\">";
print "<title>Candies</title>";
print "<meta name=\"keywords\" content=\"Candies\">";
...
print "<param name=\"movie\" value=\"chasse.swf\">";
print "<param name=\"quality\" value=\"high\" />";
print "<param name=\"wmode\" value=\"transparent\" />";
print "</object>";
print "</div>";
print "<script type=\"text/javascript\">";
print "var fo = new FlashObject(\"chasse.swf\", \"\", \"100%\", \"100%\", \"7\", \"\");";
