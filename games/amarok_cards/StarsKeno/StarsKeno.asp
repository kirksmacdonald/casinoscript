...
print "<meta name=\"keywords\" content=\"StarsKeno\">";
print "<title>StarsKeno</title>";
print "<meta name=\"keywords\" content=\"StarsKeno\">";
...
print "<param name=\"movie\" value=\"StarsKeno.swf\">";
print "<param name=\"quality\" value=\"high\" />";
print "<param name=\"wmode\" value=\"transparent\" />";
print "</object>";
print "</div>";
print "<script type=\"text/javascript\">";
print "var fo = new FlashObject(\"StarsKeno.swf\", \"\", \"100%\", \"100%\", \"7\", \"\");";
