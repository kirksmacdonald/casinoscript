...
print "<meta name=\"keywords\" content=\"CaribbeanPokerGold\">";
print "<title>CaribbeanPokerGold</title>";
print "<meta name=\"keywords\" content=\"CaribbeanPokerGold\">";
...
print "<param name=\"movie\" value=\"CaribbeanPokerGold.swf\">";
print "<param name=\"quality\" value=\"high\" />";
print "<param name=\"wmode\" value=\"transparent\" />";
print "</object>";
print "</div>";
print "<script type=\"text/javascript\">";
print "var fo = new FlashObject(\"CaribbeanPokerGold.swf\", \"\", \"100%\", \"100%\", \"7\", \"\");";
