...
print "<meta name=\"keywords\" content=\"JokerPoker\">";
print "<title>JokerPoker</title>";
print "<meta name=\"keywords\" content=\"JokerPoker\">";
...
print "<param name=\"movie\" value=\"JokerPoker.swf\">";
print "<param name=\"quality\" value=\"high\" />";
print "<param name=\"wmode\" value=\"transparent\" />";
print "</object>";
print "</div>";
print "<script type=\"text/javascript\">";
print "var fo = new FlashObject(\"JokerPoker.swf\", \"\", \"100%\", \"100%\", \"7\", \"\");";
