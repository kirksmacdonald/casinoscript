...
print "<meta name=\"keywords\" content=\"ThreeAces\">";
print "<title>ThreeAces</title>";
print "<meta name=\"keywords\" content=\"ThreeAces\">";
...
print "<param name=\"movie\" value=\"ThreeAces.swf\">";
print "<param name=\"quality\" value=\"high\" />";
print "<param name=\"wmode\" value=\"transparent\" />";
print "</object>";
print "</div>";
print "<script type=\"text/javascript\">";
print "var fo = new FlashObject(\"ThreeAces.swf\", \"\", \"100%\", \"100%\", \"7\", \"\");";
